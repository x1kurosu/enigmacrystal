...
QatuIcon::       INCBIN "gfx/icons/qatu.2bpp"
...
CurstrawIcon::   INCBIN "gfx/icons/curstraw.2bpp"
PangshiIcon::    INCBIN "gfx/icons/pangshi.2bpp"
...
PraxeIcon::      INCBIN "gfx/icons/praxe.2bpp"
