...
TilesetJohtoOceanGFX::
INCBIN "gfx/tilesets/johto_ocean.2bpp.lz"

TilesetJohtoOceanMeta::
...
TilesetSeaCaveGFX::
INCBIN "gfx/tilesets/sea_cave.2bpp.lz"

TilesetSeaCaveMeta::
INCBIN "data/tilesets/sea_cave_metatiles.bin"

TilesetSeaCaveColl::
INCLUDE "data/tilesets/sea_cave_collision.asm"
