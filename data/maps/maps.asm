...
; pointers to the first map of each map group
	...
	dw MapGroup_SouthernSea ; 23
	dw MapGroup_Viridian    ; 24
	dw MapGroup_NewBark     ; 25
	dw MapGroup_Saffron     ; 26
	dw MapGroup_Cherrygrove ; 27
...
MapGroup_Olivine:
	...
	map MooMooFarm, TILESET_JOHTO, TOWN, LANDMARK_MOOMOO_FARM, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Mahogany:
	...
	map Route46EcruteakGate, TILESET_GATE, GATE, LANDMARK_ROUTE_46, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route46, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_46, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route48, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_48, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Dungeons:
	...
	map RuinsOfAlphOutside, TILESET_JOHTO_RUINS, ROUTE, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map RuinsOfAlphResearchReception, TILESET_FACILITY, INDOOR, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphResearchExperimental, TILESET_FACILITY, INDOOR, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map UnionCave1FTunnel, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map UnionCaveB1F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map UnionCaveB1FTunnel, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE	
	map UnionCaveB2F, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map UnionCaveB2FTunnel, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map UnionCaveB2FSnakeRoom, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map UnionCaveB3F, TILESET_SEA_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UnionCaveB4F, TILESET_SEA_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UnionCaveB4FPath, TILESET_SEA_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UnionCaveB5F, TILESET_SEA_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map WhirlIslandCave, TILESET_SEA_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	...
	map WhirlIslandB1F, TILESET_SEA_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandB2F, TILESET_SEA_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandLugiaChamber, TILESET_SEA_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	...
	map SpringCave1F, TILESET_CAVE, CAVE, LANDMARK_SPRING_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map SpringCaveB1F, TILESET_CAVE, CAVE, LANDMARK_SPRING_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map SpringCaveSnakeRoom, TILESET_CAVE, CAVE, LANDMARK_SPRING_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Blackthorn:
	...
	map Route49, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_49, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route50, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_50, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_LakeOfRage:
	...
	map Route47MahoganyGate, TILESET_GATE, GATE, LANDMARK_ROUTE_47, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route47Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_47, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route47, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_47, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Violet:
	...
	map VioletFalknersHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VioletCutHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VioletHiddenHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map Route42GoldenrodGate, TILESET_GATE, GATE, LANDMARK_ROUTE_42, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodAptReception, TILESET_HOUSE, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodAptHall2F, TILESET_HOUSE, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodAptHall3F, TILESET_HOUSE, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodAptRooms2F, TILESET_HOUSE, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodAptRooms3F, TILESET_HOUSE, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE	
	map GoldenrodAptRoof, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map Route41, TILESET_JOHTO_OCEAN, ROUTE, LANDMARK_ROUTE_41, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_SouthernSea:
	table_width MAP_LENGTH, MapGroup_SouthernSea
	map Route42, TILESET_JOHTO_OCEAN, ROUTE, LANDMARK_ROUTE_42, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route43, TILESET_JOHTO_OCEAN, ROUTE, LANDMARK_ROUTE_43, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_SOUTHERN_SEA_MAPS
...
MapGroup_NewBark:
	...
	map Route29Route50Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
