...
TreeMonMaps:
	...
	treemon_map ROUTE_42,                  TREEMON_SET_BEACH
	treemon_map ROUTE_43,                  TREEMON_SET_BEACH
	treemon_map ROUTE_46,                  TREEMON_SET_TOWN
	treemon_map ROUTE_47,                  TREEMON_SET_LAKE
	treemon_map ROUTE_48,                  TREEMON_SET_CANYON
	treemon_map ROUTE_49,                  TREEMON_SET_CANYON
	treemon_map ROUTE_50,                  TREEMON_SET_CANYON
