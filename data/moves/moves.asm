...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move POUND,        EFFECT_NORMAL_HIT,         40, NORMAL,        90, 35,   0
	move KARATE_CHOP,  EFFECT_NORMAL_HIT,         50, FIGHTING,      90, 25,   0
	...
	move PAY_DAY,      EFFECT_PAY_DAY,            40, NORMAL,        90, 20,   0
	move FIRE_PUNCH,   EFFECT_BURN_HIT,           75, FIRE,          90, 15,  10
	move ICE_PUNCH,    EFFECT_FREEZE_HIT,         75, ICE,           90, 15,  10
	move THUNDERPUNCH, EFFECT_PARALYZE_HIT,       75, ELECTRIC,      90, 15,  10
	move SCRATCH,      EFFECT_NORMAL_HIT,         40, NORMAL,        90, 35,   0
	move VICEGRIP,     EFFECT_NORMAL_HIT,         55, BUG,           90, 30,   0
	move GUILLOTINE,   EFFECT_OHKO,                0, NORMAL,        30,  5,   0
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,         80, FLYING,       100, 10,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         50, NORMAL,        95, 30,   0
	move GUST,         EFFECT_GUST,               40, FLYING,        90, 35,   0
	move WING_ATTACK,  EFFECT_NORMAL_HIT,         60, BIRD_TYPE,     90, 35,   0
	move WHIRLWIND,    EFFECT_FORCE_SWITCH,        0, FLYING,        90, 20,   0
	...
	move VINE_WHIP,    EFFECT_FLINCH_HIT,         40, GRASS,         90, 35,  10
	move STOMP,        EFFECT_STOMP,              65, NORMAL,        90, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING,      90, 30,   0
	...
	move SAND_ATTACK,  EFFECT_ACCURACY_DOWN,       0, GROUND,        90, 15,   0
	move HEADBUTT,     EFFECT_FLINCH_HIT,         70, NORMAL,        90, 15,  30
	move HORN_ATTACK,  EFFECT_NORMAL_HIT,         65, NORMAL,        90, 25,   0
	...
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL,        90, 15,  30
	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL,        85, 20,   0
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,        100, NORMAL,        95, 20,   0
	move THRASH,       EFFECT_RAMPAGE,            90, NORMAL,        90, 20,   0
	move DOUBLE_EDGE,  EFFECT_RECOIL_HIT,        120, NORMAL,        90, 15,   0
	move TAIL_WHIP,    EFFECT_DEFENSE_DOWN,        0, NORMAL,        90, 30,   0
	move POISON_STING, EFFECT_POISON_HIT,         40, POISON,        90, 35,  50
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,        65, 20,   0
	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      20, NORMAL,        80, 20,   0
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,        55, 20,   0
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   40, POISON,        90, 30,  80
	move EMBER,        EFFECT_BURN_HIT,           40, FIRE,          90, 25,  20
	move FLAMETHROWER, EFFECT_BURN_HIT,           95, FIRE,          80, 15,  10
	move MIST,         EFFECT_MIST,                0, ICE,          100, 30,   0
	move WATER_GUN,    EFFECT_NORMAL_HIT,         40, WATER,         90, 25,   0
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        120, WATER,         80,  5,   0
	move SURF,         EFFECT_NORMAL_HIT,         95, WATER,         80, 15,   0
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         95, ICE,           80, 10,  10
	move BLIZZARD,     EFFECT_BLIZZARD,          140, ICE,           65,  5,  40
	move PSYBEAM,      EFFECT_CONFUSE_HIT,        65, PSYCHIC_TYPE,  90, 20,  10
	move BUBBLEBEAM,   EFFECT_SPEED_DOWN_HIT,     65, WATER,         90, 20,  50
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    65, ICE,           90, 20,  50
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,        90,  5,   0
	move PECK,         EFFECT_NORMAL_HIT,         40, BIRD_TYPE,     90, 35,   0
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         80, BIRD_TYPE,     90, 20,   0
	...
	move SEISMIC_TOSS, EFFECT_LEVEL_DAMAGE,        1, FIGHTING,      90, 20,   0
	move STRENGTH,     EFFECT_NORMAL_HIT,         80, NORMAL,        90, 15,   0
	move ABSORB,       EFFECT_LEECH_HIT,          30, GRASS,         90, 25,   0
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          55, GRASS,         90, 15,   0
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, GRASS,         95, 15,   0
	move GROWTH,       EFFECT_SP_ATK_UP,           0, GRASS,        100, 40,   0
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         55, GRASS,         95, 25,   0
	move SOLARBEAM,    EFFECT_SOLARBEAM,         160, GRASS,         95, 10,   0
	...
	move PETAL_DANCE,  EFFECT_PETAL_DANCE,        70, GRASS,         90, 20,   0
	move STRING_SHOT,  EFFECT_ATTACK_DOWN,         0, BUG,          100, 40,   0
	move DRAGON_RAGE,  EFFECT_STATIC_DAMAGE,      40, DRAGON,        90, 10,   0
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        25, FIRE,          90, 15,   0
	move THUNDERSHOCK, EFFECT_PARALYZE_HIT,       40, ELECTRIC,      90, 30,  20
	move THUNDERBOLT,  EFFECT_PARALYZE_HIT,       95, ELECTRIC,      80, 15,  10
	move THUNDER_WAVE, EFFECT_PARALYZE,            0, ELECTRIC,      95, 20,   0
	move THUNDER,      EFFECT_THUNDER,           110, ELECTRIC,      75, 10,  30
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         50, ROCK,          90, 15,   0
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,        100, GROUND,        80, 10,   0
	move FISSURE,      EFFECT_OHKO,                1, GROUND,        30,  5,   0
	move DIG,          EFFECT_FLY,                60, GROUND,        90, 10,   0
	move POISON_FANG,  EFFECT_TOXIC,              65, POISON,        80, 15,  50
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC_TYPE,  90, 25,  10
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC_TYPE,  80, 10,  10
	...
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, NORMAL,        90, 30,   0
	move RAGE,         EFFECT_RAGE,               20, NORMAL,        90, 20,   0
	move TELEPORT,     EFFECT_TELEPORT,            0, PSYCHIC_TYPE, 100, 20,   0
	move NIGHT_SHADE,  EFFECT_LEVEL_DAMAGE,        1, GHOST,         90, 15,   0
	move MIMIC,        EFFECT_MIMIC,               0, NORMAL,       100, 10,   0
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,        95, 40,   0
	move DOUBLE_TEAM,  EFFECT_EVASION_UP,          0, NORMAL,       100, 15,   0
	move RECOVER,      EFFECT_HEAL,                0, NORMAL,       100, 20,   0
	move HARDEN,       EFFECT_DEFENSE_UP,          0, ROCK,         100, 30,   0
	...
	move HAZE,         EFFECT_RESET_STATS,         0, POISON,       100, 15,   0
	...
	move METRONOME,    EFFECT_METRONOME,           0, NORMAL,        90, 10,   0
	move MIRROR_MOVE,  EFFECT_MIRROR_MOVE,         0, BIRD_TYPE,    100, 20,   0
	move SELFDESTRUCT, EFFECT_SELFDESTRUCT,      200, NORMAL,       100,  5,   0
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL,        75, 10,   0
	move LICK,         EFFECT_PARALYZE_HIT,       35, GHOST,         90, 30,  30
	move SMOG,         EFFECT_POISON_HIT,         20, POISON,        70, 20,  60
	move SLUDGE,       EFFECT_POISON_HIT,         65, POISON,        90, 20,  30
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, GROUND,        85, 20,  10
	move FIRE_BLAST,   EFFECT_BURN_HIT,          150, FIRE,          60,  5, 100
	move WATERFALL,    EFFECT_NORMAL_HIT,         80, WATER,         90, 15,   0
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,         75, 10,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,       100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        120, NORMAL,       100, 15,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, NORMAL,        90, 15,   0
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     30, NORMAL,        90, 35, 100
	...
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     30, WATER,         90, 30, 100
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL,        85, 10,  80
	...
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,        80, 40,   0
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,          90, 15,  30
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,        90, 15,  10
	move SHARPEN,      EFFECT_ATTACK_UP,           0, ROCK,         100, 30,   0
	move CONVERSION,   EFFECT_CONVERSION,          0, NORMAL,       100, 30,   0
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         80, NORMAL,        90, 10,  50
	move SUPER_FANG,   EFFECT_SUPER_FANG,          1, NORMAL,        90, 10,   0
	move SLASH,        EFFECT_NORMAL_HIT,         70, NORMAL,        90, 20,   0
	...
	move THIEF,        EFFECT_THIEF,              40, DARK,          90, 10, 100
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,          90, 25,  10
	...
	move AEROBLAST,    EFFECT_NORMAL_HIT,        110, FLYING,        95,  5,   0
	move COTTON_SPORE, EFFECT_SPEED_DOWN_2,        0, GRASS,         85, 40,   0
	move REVERSAL,     EFFECT_REVERSAL,            1, FIGHTING,      90, 15,   0
	move SPITE,        EFFECT_SPITE,               0, GHOST,        100, 10,   0
	move POWDER_SNOW,  EFFECT_FREEZE_HIT,         40, ICE,           90, 25,  20
	move PROTECT,      EFFECT_PROTECT,             0, NORMAL,       100, 10,   0
	move MACH_PUNCH,   EFFECT_PRIORITY_HIT,       40, FIGHTING,      90, 30,   0
	move SCARY_FACE,   EFFECT_SPEED_DOWN_2,        0, DARK,          90, 10,   0
	...
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         90, POISON,        90, 10,  30
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  30, GROUND,        80, 10, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,         85, 10,  50
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,       100, 20,   0
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      150, ELECTRIC,      60,  5, 100
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     55, ICE,           95, 15,  90
	...
	move OUTRAGE,      EFFECT_RAMPAGE,            90, DRAGON,        90, 15,   0
	move SANDSTORM,    EFFECT_SANDSTORM,           0, ROCK,         100, 15,   0
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          75, GRASS,         90, 10,   0
	...
	move SPARK,        EFFECT_PARALYZE_HIT,       65, ELECTRIC,      90, 20,  30
	...
	move RETURN,       EFFECT_RETURN,              1, NORMAL,        90, 20,   0
	move PRESENT,      EFFECT_PRESENT,             1, NORMAL,        90, 15,   0
	move FRUSTRATION,  EFFECT_FRUSTRATION,         1, DARK,          90, 20,   0
	move SAFEGUARD,    EFFECT_SAFEGUARD,           0, NORMAL,       100, 25,   0
	move PAIN_SPLIT,   EFFECT_PAIN_SPLIT,          0, GHOST,        100, 20,   0
	move SACRED_FIRE,  EFFECT_SACRED_FIRE,       100, FIRE,          85,  5, 100
	move MAGNITUDE,    EFFECT_MAGNITUDE,           1, GROUND,        90, 30,   0
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       100, FIGHTING,      50,  5, 100
	move MEGAHORN,     EFFECT_NORMAL_HIT,        120, BUG,           85, 10,   0
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       60, DRAGON,        90, 20,  50
	move BATON_PASS,   EFFECT_BATON_PASS,          0, NORMAL,       100, 40,   0
	move ENCORE,       EFFECT_ENCORE,              0, NORMAL,       100,  5,   0
	move PURSUIT,      EFFECT_PURSUIT,            40, DARK,          90, 20,   0
	move RAPID_SPIN,   EFFECT_RAPID_SPIN,         20, NORMAL,        90, 40,   0
	move SWEET_SCENT,  EFFECT_SWEET_SCENT,         0, GRASS,        100, 15,   0
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,         75, 15,  30
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      40, STEEL,         90, 35,  20
	move VITAL_THROW,  EFFECT_ALWAYS_HIT,         70, FIGHTING,      90, 10,   0
	move MORNING_SUN,  EFFECT_MORNING_SUN,         0, FIRE,         100,  5,   0
	move SYNTHESIS,    EFFECT_SYNTHESIS,           0, GRASS,        100,  5,   0
	move MOONLIGHT,    EFFECT_MOONLIGHT,           0, DARK,         100,  5,   0
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,        1, NORMAL,        90, 15,   0
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,      80,  5,   0
	move TWISTER,      EFFECT_TWISTER,            40, DRAGON,        90, 20,  20
	move RAIN_DANCE,   EFFECT_RAIN_DANCE,          0, WATER,        100, 15,   0
	move SUNNY_DAY,    EFFECT_SUNNY_DAY,           0, FIRE,         100, 15,   0
	move CRUNCH,       EFFECT_SP_DEF_DOWN_HIT,    80, DARK,          90, 15,  20
	move MIRROR_COAT,  EFFECT_MIRROR_COAT,         1, PSYCHIC_TYPE, 100, 20,   0
	move PSYCH_UP,     EFFECT_PSYCH_UP,            0, PSYCHIC_TYPE, 100, 10,   0
	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       80, NORMAL,        90,  5,   0
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,          90,  5,  10
	move SHADOW_BALL,  EFFECT_DEFENSE_DOWN_HIT,   90, GHOST,         90, 15,  20
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      140, PSYCHIC_TYPE,  95, 15,   0
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   30, FIGHTING,      90, 30,  80
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        25, WATER,         90, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,          90, 10,   0
	move HAIL,         EFFECT_HAIL,                0, ICE,          100, 15,   0
	move HURRICANE,    EFFECT_CONFUSE_HIT,       120, FLYING,        60,  5,  50
