...
FalknerGroup:
	...
	db  7, DODUO,      PECK, GROWL, MUD_SLAP, NO_MOVE
...
WhitneyGroup:
	...
	db 21, SNUBBULL,   TACKLE, CHARM, TAIL_WHIP, BITE
...
BugsyGroup:
	...
	db 17, LEDIAN,	   TACKLE, SUPERSONIC, COMET_PUNCH, ICE_PUNCH
...
MortyGroup:
	...
	db 25, STANTLER,   HYPNOSIS, PSYBEAM, STOMP, CONFUSE_RAY
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 37, DELIBIRD,   SPIKES, ICY_WIND, PRESENT, NO_MOVE
	db 38, LAPRAS,     BODY_SLAM, CONFUSE_RAY, ICE_BEAM, SING
	db 37, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 39, PILOSWINE,  ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 37, SKARMORY,   STEEL_WING, SAND_ATTACK, FLY, AGILITY
	db 36, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 38, STEELIX,    SCREECH, ROCK_THROW, IRON_TAIL, NO_MOVE
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 32, HITMONTOP,  PURSUIT, QUICK_ATTACK, ROLLING_KICK, COUNTER
	db 33, PRIMEAPE,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 34, URSARING,   FAINT_ATTACK, REST, SNORE, DYNAMICPUNCH
...
ClairGroup:
	...
	db 41, GYARADOS,   TWISTER, HYDRO_PUMP, BITE, LEER
	db 40, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 41, NIDOQUEEN,  MEGA_PUNCH, FIRE_PUNCH, LOVELY_KISS, EARTHQUAKE
	db 43, KINGDRA,    SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
KogaGroup:
	...
	db 41, VENOMOTH,   SUPERSONIC, GUST, PSYCHIC_M, POISONPOWDER
	db 43, FORRETRESS, PROTECT, SWIFT, EXPLOSION, SPIKES
	db 42, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, POISON_GAS
	db 44, CROBAT,     DOUBLE_TEAM, QUICK_ATTACK, WING_ATTACK, POISON_FANG
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, FLY
...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, POISON_GAS, EXPLOSION
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, POISON_GAS, EXPLOSION
...
CooltrainerMGroup:
	...
	db 35, VICTREEBEL, WRAP, POISONPOWDER, ACID, RAZOR_LEAF
	...
	db 39, VICTREEBEL, NO_ITEM,      GIGA_DRAIN, POISONPOWDER, SLUDGE_BOMB, RAZOR_LEAF
	...
	; COOLTRAINERM (10)
	db "GAVEN@", TRAINERTYPE_MOVES
	db 32, VICTREEBEL, WRAP, POISONPOWDER, ACID, RAZOR_LEAF
...
CooltrainerFGroup:
	...
	db 40, NIDOQUEEN,  PINK_BOW,     EARTHQUAKE, DOUBLE_KICK, POISON_FANG, BODY_SLAM
...
BugCatcherGroup:
	...
	; BUG_CATCHER (18)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 40, VENOMOTH,   GUST, SUPERSONIC, PSYCHIC_M, POISONPOWDER
	db -1 ; end
...
FisherGroup:
	...
	db 35, QWILFISH,   PIN_MISSILE, MINIMIZE, SURF, PIN_MISSILE
...
Rival2Group:
	...
	db 48, CROBAT,     POISON_FANG, BITE, CONFUSE_RAY, WING_ATTACK
...
BlackbeltGroup:
	...
	db 33, ONIX,       BIND, ROCK_THROW, SAND_ATTACK, DIG
...
MysticalmanGroup:
	...
	db 29, HAUNTER,    LICK, HYPNOSIS, MEAN_LOOK, CURSE
