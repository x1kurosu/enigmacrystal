...
; BattleTowerMons group 1
	...
	db ESPEON
	db LEFTOVERS
	db MUD_SLAP, PSYCHIC_M, PSYCH_UP, CHARM
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db GOLD_APPLE
	db SHADOW_BALL, IRON_TAIL, PSYCH_UP, CHARM
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db MILTANK
	db GOLD_APPLE
	db BLIZZARD, EARTHQUAKE, HYPER_BEAM, ATTRACT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db EXEGGUTOR
	db KINGS_ROCK
	db HYPNOSIS, GIGA_DRAIN, THIEF, CONFUSION
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db MR__MIME
	db QUICK_CLAW
	db BATON_PASS, PSYCH_UP, FIRE_PUNCH, HEADBUTT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 2
	...
	db UMBREON
	db LEFTOVERS
	db PROTECT, POISON_STING, MUD_SLAP, ATTRACT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ALAKAZAM
	db BERRY_JUICE
	db PSYCHIC_M, PSYCH_UP, REFLECT, THUNDERPUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db LEFTOVERS
	db HYPER_BEAM, PSYCHIC_M, HYPNOSIS, DREAM_EATER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PIKACHU
	db LIGHT_BALL
	db THUNDERBOLT, THUNDER_WAVE, STRENGTH, CHARM
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SCIZOR
	db FOCUS_BAND
	db STEEL_WING, SLASH, CURSE, SANDSTORM
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 3
	...
	db BLISSEY
	db LEFTOVERS
	db CHARM, REFLECT, SOFTBOILED, PROTECT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CROBAT
	db GOLD_APPLE
	db ATTRACT, CONFUSE_RAY, POISON_FANG, WING_ATTACK
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ESPEON
	db MIRACLEBERRY
	db CONFUSION, SWIFT, REFLECT, PSYCH_UP
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db TENTACRUEL
	db KINGS_ROCK
	db WRAP, BARRIER, SLUDGE_BOMB, BUBBLEBEAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 4
	...
	db STEELIX
	db GOLD_APPLE
	db SANDSTORM, IRON_TAIL, EARTHQUAKE, CURSE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db FORRETRESS
	db LEFTOVERS
	db RAPID_SPIN, PROTECT, SPIKES, SANDSTORM
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MUK
	db QUICK_CLAW
	db SCREECH, SLUDGE_BOMB, SLUDGE, HARDEN
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 5
	...
	db SHUCKLE
	db LEFTOVERS
	db SANDSTORM, REST, POISON_STING, WRAP
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db CROBAT
	db LEFTOVERS
	db CONFUSE_RAY, ATTRACT, HYPER_BEAM, POISON_FANG
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db FORRETRESS
	db LEFTOVERS
	db SANDSTORM, RAPID_SPIN, EXPLOSION, SWAGGER
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 6
	...
	db PORYGON2
	db LEFTOVERS
	db BLIZZARD, RECOVER, THUNDERBOLT, PSYCHIC_M
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SKARMORY
	db MIRACLEBERRY
	db STEEL_WING, FLY, CURSE, PROTECT
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BLISSEY
	db LEFTOVERS
	db SOFTBOILED, CHARM, PROTECT, PSYCHIC_M
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 7
	...
	db UMBREON
	db GOLD_APPLE
	db FAINT_ATTACK, MOONLIGHT, PSYCH_UP, CURSE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
...
; BattleTowerMons group 8
	...
	db FORRETRESS
	db LEFTOVERS
	db EXPLOSION, SPIKES, SOLARBEAM, SWAGGER
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SKARMORY
	db QUICK_CLAW
	db STEEL_WING, FLY, MUD_SLAP, CURSE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ELECTRODE
	db KINGS_ROCK
	db THUNDERBOLT, EXPLOSION, MIRROR_COAT, RAPID_SPIN
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db VICTREEBEL
	db QUICK_CLAW
	db GIGA_DRAIN, SLUDGE_BOMB, HYPER_BEAM, WRAP
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db PINSIR
	db GOLD_APPLE
	db HYPER_BEAM, SUBMISSION, STRENGTH, BIND
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db PORYGON2
	db QUICK_CLAW
	db THUNDERBOLT, PSYCHIC_M, RECOVER, PROTECT
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SKARMORY
	db QUICK_CLAW
	db SANDSTORM, STEEL_WING, CURSE, RETURN
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SHUCKLE
	db LEFTOVERS
	db POISON_STING, WRAP, PROTECT, ENCORE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MUK
	db QUICK_CLAW
	db ACID_ARMOR, SLUDGE_BOMB, ATTRACT, GIGA_DRAIN
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 10
	...
	db KINGDRA
	db LEFTOVERS
	db SURF, DRAGONBREATH, REST, WHIRLPOOL
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db SCIZOR
	db QUICK_CLAW
	db STEEL_WING, HYPER_BEAM, SLASH, SANDSTORM
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db QUICK_CLAW
	db PSYCHIC_M, HYPNOSIS, EXPLOSION, GIGA_DRAIN
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db OMASTAR
	db LEFTOVERS
	db SURF, ANCIENTPOWER, BLIZZARD, PROTECT
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
