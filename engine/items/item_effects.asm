...
; entries correspond to item ids (see constants/item_constants.asm)
	...
	dw NoEffect            ; PASS
	dw NoEffect            ; MAGMA_ARMOR
	dw NoEffect            ; SHED_ELYTRA
	dw NoEffect            ; ITEM_89
	...
	dw NoEffect            ; ITEM_94
	dw NoEffect            ; ITEM_95
	dw RestorePPEffect     ; DRAGONFRUIT
