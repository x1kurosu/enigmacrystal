...
VermilionCity_MapEvents:
	...
	def_object_events
	object_event 18,  9, SPRITE_LADY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VermilionCityTeacherScript, -1
	...
	object_event 14, 16, SPRITE_PSYCHIC, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, VermilionCitySuperNerdScript, -1
