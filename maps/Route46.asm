	object_const_def
	const ROUTE46_FISHER
	const ROUTE46_POKEFAN_M
	const ROUTE46_SUPER_NERD
	...
	const ROUTE46_SUICUNE

Route46_MapScripts:
	def_scene_scripts
	scene_script Route46Noop1Scene, SCENE_ROUTE46_NOOP
	scene_script Route46Noop2Scene, SCENE_ROUTE46_SUICUNE
...
Route46SuicuneScript:
	showemote EMOTE_SHOCK, PLAYER, 15
	pause 15
	playsound SFX_WARP_FROM
	applymovement ROUTE46_SUICUNE, Route46SuicuneMovement
	disappear ROUTE46_SUICUNE
	pause 10
	setscene SCENE_ROUTE46_NOOP
...
Route46HiddenMaxPotion:
	hiddenitem MAX_POTION, EVENT_ROUTE_46_HIDDEN_MAX_POTION

Route46SuicuneMovement:
	set_sliding
	fast_jump_step UP
	fast_jump_step UP
	fast_jump_step UP
...
Route46_MapEvents:
	...
	def_warp_events
	warp_event  0,  8, ROUTE_46_ECRUTEAK_GATE, 3
	warp_event  0,  9, ROUTE_46_ECRUTEAK_GATE, 4
	...
	def_coord_events
	coord_event 24, 14, SCENE_ROUTE46_SUICUNE, Route46SuicuneScript

	def_bg_events
	bg_event  4, 10, BGEVENT_READ, Route46Sign1
	bg_event  7,  5, BGEVENT_READ, MtMortarSign1
	bg_event 45,  9, BGEVENT_READ, MtMortarSign2
	bg_event 54,  8, BGEVENT_READ, Route46Sign2
	bg_event 16, 11, BGEVENT_ITEM, Route46HiddenMaxPotion
	...
	object_event 47,  8, SPRITE_PSYCHIC, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerPokemaniacShane, -1
	object_event 27, 16, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route46FruitTree1, -1
	object_event 28, 16, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route46FruitTree2, -1
	object_event 29, 16, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route46FruitTree3, -1
	object_event  6,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route46UltraBall, EVENT_ROUTE_46_ULTRA_BALL
	object_event 33,  8, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route46SuperPotion, EVENT_ROUTE_46_SUPER_POTION
	object_event 26, 16, SPRITE_SUICUNE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_SAW_SUICUNE_ON_ROUTE_46
