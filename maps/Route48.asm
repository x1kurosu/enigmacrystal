	object_const_def
	const ROUTE48_FISHER1
	const ROUTE48_FISHER2
	const ROUTE48_YOUNGSTER1
	const ROUTE48_SUPER_NERD
	const ROUTE48_YOUNGSTER2
	const ROUTE48_COOLTRAINER_M
	const ROUTE48_COOLTRAINER_F
	const ROUTE48_FRUIT_TREE
	const ROUTE48_POKE_BALL1
	const ROUTE48_POKE_BALL2
	const ROUTE48_POKE_BALL3
...
.Script:
	...
	iftrue Route48NumberAcceptedM
	checkevent EVENT_VANCE_ASKED_FOR_PHONE_NUMBER
	iftrue .AskedAlready
	writetext BirdKeeperVanceLegendaryBirdsText
	promptbutton
	setevent EVENT_VANCE_ASKED_FOR_PHONE_NUMBER
	scall Route48AskNumber1M
	sjump .AskForNumber

.AskedAlready:
	scall Route48AskNumber2M
.AskForNumber:
	askforphonenumber PHONE_BIRDKEEPER_VANCE
	ifequal PHONE_CONTACTS_FULL, Route48PhoneFullM
	ifequal PHONE_CONTACT_REFUSED, Route48NumberDeclinedM
	gettrainername STRING_BUFFER_3, BIRD_KEEPER, VANCE1
	scall Route48RegisteredNumberM
	sjump Route48NumberAcceptedM

.WantsBattle:
	scall Route48RematchM
...
Route48RegisteredNumberM:
	jumpstd RegisteredNumberMScript
	end

Route48NumberAcceptedM:
	jumpstd NumberAcceptedMScript
	end

Route48NumberDeclinedM:
...
Route48HiddenElixer:
	hiddenitem ELIXER, EVENT_ROUTE_48_HIDDEN_ELIXER
...
Route48_MapEvents:
	...
	def_bg_events
	bg_event 53,  7, BGEVENT_READ, Route48Sign1
	bg_event  6, 10, BGEVENT_READ, Route48Sign2
	bg_event 32,  9, BGEVENT_ITEM, Route48HiddenElixer
	...
	object_event 10,  9, SPRITE_BOY, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerPsychicPhil, -1
	object_event 43,  2, SPRITE_PSYCHIC, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerPokemaniacZach, -1
	object_event 51,  5, SPRITE_BOY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 2, TrainerBirdKeeperVance1, -1
	...
	object_event  9,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route48FruitTree, -1
	object_event 30,  8, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route48MaxRevive, EVENT_ROUTE_48_MAX_REVIVE
	object_event 45,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route48UltraBall, EVENT_ROUTE_48_ULTRA_BALL
	object_event 14,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route48MaxRepel, EVENT_ROUTE_48_MAX_REPEL
