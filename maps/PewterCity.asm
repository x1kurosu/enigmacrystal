...
PewterCityBoyScript:
	jumptextfaceplayer PewterCityBoyText
...
PewterCity_MapEvents:
	...
	object_event 14, 29, SPRITE_BOY, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, PewterCityBoyScript, -1
