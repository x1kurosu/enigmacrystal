...
NewBarkTownLedybaScript:
	opentext
	writetext Text_NewBarkTownLedyba
	cry LEDYBA
	waitbutton
	closetext
	end
...
NewBarkTown_MapEvents:
	...
	def_object_events
	object_event  6,  8, SPRITE_LADY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownTeacherScript, -1
	object_event 13,  9, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, NewBarkTownFisherScript, -1
	...
	object_event 10, 10, SPRITE_LEDYBA, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, NewBarkTownLedybaScript, -1
