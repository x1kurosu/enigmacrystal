...
.WadeItem:
	...
	iftrue .Berry
	checkevent EVENT_WADE_HAS_SWEET_PEACH
	iftrue .SweetPeach
	checkevent EVENT_WADE_HAS_STRAWBERRY
	iftrue .Strawberry
	checkevent EVENT_WADE_HAS_RIPE_BANANA
	iftrue .RipeBanana
.Berry:
	...
	sjump .Done
.SweetPeach:
	verbosegiveitem SWEET_PEACH
	iffalse .PackFull
	sjump .Done
.Strawberry:
	verbosegiveitem STRAWBERRY
	iffalse .PackFull
	sjump .Done
.RipeBanana:
	verbosegiveitem RIPE_BANANA
	iffalse .PackFull
.Done:
