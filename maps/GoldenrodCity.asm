...
GoldenrodCity_MapEvents:
	...
	warp_event  2, 16, ROUTE_42_GOLDENROD_GATE, 3
	warp_event  2, 17, ROUTE_42_GOLDENROD_GATE, 4
	...
	object_event  6, 19, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocketScoutScript, EVENT_GOLDENROD_CITY_ROCKET_SCOUT
