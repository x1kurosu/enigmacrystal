...
EcruteakCity_MapEvents:
	...
	def_warp_events
	warp_event 35, 26, ROUTE_46_ECRUTEAK_GATE, 1
	warp_event 35, 27, ROUTE_46_ECRUTEAK_GATE, 2
	...
	object_event 21, 29, SPRITE_GIRL, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, EcruteakCityLass1Script, -1
	object_event  3,  9, SPRITE_GIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EcruteakCityLass2Script, -1
	...
	object_event 10, 14, SPRITE_BOY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, EcruteakCityYoungsterScript, -1
