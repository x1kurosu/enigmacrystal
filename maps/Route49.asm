	object_const_def
	const ROUTE49_POKEFAN_M1
	const ROUTE49_POKEFAN_M2
	const ROUTE49_POKEFAN_M3
	const ROUTE49_POKEFAN_M4
	const ROUTE49_BLACK_BELT
	const ROUTE49_COOLTRAINER_M
	const ROUTE49_COOLTRAINER_F
	const ROUTE49_FRUIT_TREE
	const ROUTE49_POKE_BALL1
	const ROUTE49_POKE_BALL2
	const ROUTE49_POKE_BALL3
	const ROUTE49_POKE_BALL4
...
.Script:
	...
	scall Route49AskNumber1M
	sjump .AskForNumber

.AskedAlready:
	scall Route49AskNumber2M
.AskForNumber:
	askforphonenumber PHONE_BLACKBELT_KENJI
	ifequal PHONE_CONTACTS_FULL, Route49PhoneFullM
	ifequal PHONE_CONTACT_REFUSED, Route49NumberDeclinedM
	gettrainername STRING_BUFFER_3, BLACKBELT_T, KENJI3
	scall Route49RegisteredNumberM
	sjump Route49NumberAcceptedM

.Registered:
	readvar VAR_KENJI_BREAK
	ifnotequal 1, Route49NumberAcceptedM
	checktime MORN
	iftrue .Morning
	checktime EVE | NITE
	iftrue .Night
	checkevent EVENT_KENJI_ON_BREAK
	iffalse Route49NumberAcceptedM
	scall Route49GiftM
...
Route49RegisteredNumberM:
	jumpstd RegisteredNumberMScript
	end

Route49NumberAcceptedM:
	jumpstd NumberAcceptedMScript
	end

Route49NumberDeclinedM:
...
Route49DummyScript: ; unreferenced
	writetext Route49DummyText
	waitbutton
	closetext
	end
...
Route49HiddenPpUp:
	hiddenitem PP_UP, EVENT_ROUTE_49_HIDDEN_PP_UP
...
Route49_MapEvents:
	...
	def_bg_events
	bg_event 10,  4, BGEVENT_READ, Route49Sign
	bg_event 13, 80, BGEVENT_ITEM, Route49HiddenPpUp
	...
	object_event 16, 82, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route49FruitTree, -1
	object_event  6, 51, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route49Nugget, EVENT_ROUTE_49_NUGGET
	object_event  5, 66, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route49Revive, EVENT_ROUTE_49_REVIVE
	object_event  6, 20, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route49Elixer, EVENT_ROUTE_49_ELIXER
	object_event  7, 33, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route49MaxPotion, EVENT_ROUTE_49_MAX_POTION
	object_event  4, 70, SPRITE_BOY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, TrainerCamperQuentin, -1
