...
RuinsOfAlphHoOhItemRoomDragonFruit:
	itemball DRAGONFRUIT
...
RuinsOfAlphHoOhItemRoom_MapEvents:
	...
	def_object_events
	object_event  2,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphHoOhItemRoomGoldBerry, EVENT_PICKED_UP_GOLD_APPLE_FROM_HO_OH_ITEM_ROOM
	object_event  5,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphHoOhItemRoomDragonFruit, EVENT_PICKED_UP_DRAGONFRUIT_FROM_HO_OH_ITEM_ROOM
