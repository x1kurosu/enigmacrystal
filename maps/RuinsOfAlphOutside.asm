...
RuinsOfAlphOutside_MapEvents:
	...
	def_warp_events
	warp_event  4, 10, RUINS_OF_ALPH_HO_OH_CHAMBER, 1
	warp_event 24,  7, RUINS_OF_ALPH_KABUTO_CHAMBER, 1
	warp_event 10, 28, RUINS_OF_ALPH_OMANYTE_CHAMBER, 1
	warp_event 26, 32, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 1
	warp_event 20, 13, RUINS_OF_ALPH_INNER_CHAMBER, 1
	warp_event 27, 11, RUINS_OF_ALPH_RESEARCH_CENTER, 1
	warp_event 16, 19, UNION_CAVE_B1F, 1
	warp_event 16, 27, UNION_CAVE_B1F, 2
	warp_event 17,  5, ROUTE_36_RUINS_OF_ALPH_GATE, 3
	warp_event 23, 20, ROUTE_32_RUINS_OF_ALPH_GATE, 1
	warp_event 23, 21, ROUTE_32_RUINS_OF_ALPH_GATE, 2

	def_coord_events
	coord_event 21, 14, SCENE_RUINSOFALPHOUTSIDE_GET_UNOWN_DEX, RuinsOfAlphOutsideScientistScene1
	coord_event 20, 15, SCENE_RUINSOFALPHOUTSIDE_GET_UNOWN_DEX, RuinsOfAlphOutsideScientistScene2

	def_bg_events
	bg_event 26,  8, BGEVENT_READ, RuinsOfAlphOutsideMysteryChamberSign
	bg_event 22, 16, BGEVENT_READ, RuinsOfAlphSign
	bg_event 28, 12, BGEVENT_READ, RuinsOfAlphResearchCenterSign

	def_object_events
	object_event 14, 20, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerPsychicNathan, -1
	object_event 21, 15, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideScientistScript, EVENT_RUINS_OF_ALPH_OUTSIDE_SCIENTIST
	object_event 23, 17, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideFisherScript, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_FISHER
	object_event 24, 11, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideYoungster1Script, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_YOUNGSTERS
	object_event 22,  8, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideYoungster2Script, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_YOUNGSTERS
