...
RuinsOfAlphOmanyteItemRoomDragonFruit:
...
RuinsOfAlphOmanyteItemRoom_MapEvents:
	...
	def_object_events
	object_event  2,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphOmanyteItemRoomDragonFruit, EVENT_PICKED_UP_DRAGONFRUIT_FROM_OMANYTE_ITEM_ROOM
