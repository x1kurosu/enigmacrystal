...
MahoganyTown_MapEvents:
	...
	warp_event  9,  1, ROUTE_47_MAHOGANY_GATE, 3
	...
	object_event 12,  8, SPRITE_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MahoganyTownLassScript, EVENT_MAHOGANY_MART_OWNERS
