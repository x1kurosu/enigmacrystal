...
.Next2:
	...
	setmapscene ROUTE_46, SCENE_ROUTE46_NOOP
...
TinTower1F_MapEvents:
	...
	object_event  8,  3, SPRITE_PSYCHIC, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, TinTower1FEusine, EVENT_TIN_TOWER_1F_EUSINE
