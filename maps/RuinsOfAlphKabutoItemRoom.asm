...
RuinsOfAlphKabutoItemRoomSweetPeach:
	itemball SWEET_PEACH
...
RuinsOfAlphKabutoItemRoom_MapEvents:
	...
	object_event  5,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphKabutoItemRoomSweetPeach, EVENT_PICKED_UP_SWEET_PEACH_FROM_KABUTO_ITEM_ROOM
