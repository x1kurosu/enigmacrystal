...
; - ItemEffects (see engine/items/item_effects.asm)
	...
	const QUICK_CLAW   ; 49
	const SWEET_PEACH  ; 4a
	const GOLD_LEAF    ; 4b
	const SOFT_SAND    ; 4c
	const SHARP_BEAK   ; 4d
	const STRAWBERRY   ; 4e
	const SPICYPEPPER  ; 4f
	const ICE_BERRY    ; 50
	const POISON_BARB  ; 51
	const KINGS_ROCK   ; 52
	const RIPE_BANANA  ; 53
	const MINT_BERRY   ; 54
	...
	const PASS         ; 86
	const MAGMA_ARMOR  ; 87
	const SHED_ELYTRA  ; 88
	const ITEM_89      ; 89
	const CHARCOAL     ; 8a
