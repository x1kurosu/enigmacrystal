...
; Johto hidden items
	...
	const EVENT_NATIONAL_PARK_HIDDEN_PARLYZ_HEAL
	...
	const EVENT_ROUTE_46_HIDDEN_MAX_POTION
	const EVENT_ROUTE_48_HIDDEN_ELIXER
	const EVENT_ROUTE_49_HIDDEN_PP_UP
...
; More Johto story events
	...
	const EVENT_CONTEST_OFFICER_HAS_GOLD_APPLE
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_WADE_HAS_SWEET_PEACH
	const EVENT_WADE_HAS_STRAWBERRY
	const EVENT_WADE_HAS_RIPE_BANANA
...
; Teacher Male
	const EVENT_BEAT_TEACHER_PIERS
...
; Johto itemballs
	...
	const EVENT_UNION_CAVE_B3F_ICE_BERRY
	...
	const EVENT_ROUTE_46_ULTRA_BALL
	const EVENT_ROUTE_46_SUPER_POTION
	const EVENT_ROUTE_47_MAX_ETHER
	const EVENT_ROUTE_48_MAX_REVIVE
	const EVENT_ROUTE_48_ULTRA_BALL
	const EVENT_ROUTE_49_NUGGET
	const EVENT_ROUTE_49_REVIVE
	const EVENT_ROUTE_49_ELIXER
	const EVENT_ROUTE_49_MAX_POTION
	const EVENT_ROUTE_50_X_SPEED
; Johto people
	...
	const EVENT_ROUTE_47_GATE_ROCKETS
...
; New to Crystal
	...
	const EVENT_PICKED_UP_GOLD_APPLE_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_DRAGONFRUIT_FROM_HO_OH_ITEM_ROOM
	...
	const EVENT_PICKED_UP_SWEET_PEACH_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGYPOWDER_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_DRAGONFRUIT_FROM_OMANYTE_ITEM_ROOM
	...
	const EVENT_PICKED_UP_GOLD_APPLE_FROM_AERODACTYL_ITEM_ROOM
	...
	const EVENT_SAW_SUICUNE_ON_ROUTE_46
	...
	const EVENT_ROUTE_48_MAX_REPEL
